...
import { FiSearch, FiFilter, FiDownload, FiMoreVertical, FiVideo, FiMail, FiCalendar, FiClock, FiUsers, FiFileText, FiRefreshCw } from 'react-icons/fi';
            ...
            <Container>
                ...
                <Row>
                    <Col>
                        ...
                        >
                            <div>
                                <h1 className="h2 fw-bold mb-2">Meetings</h1>
                        ...
                        <Col>
                            <Card className="card-modern text-center py-5">
                                <Card.Body>
                                    ...
                                    <h5 className="text-muted">No meetings scheduled yet</h5>
                ...
                >
                    <Modal.Header closeButton>
                        <Modal.Title>Meeting Type Details</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                                ...
                                <div className="d-flex gap-2 justify-content-end mt-4">
                                    ...
                                    <Button
                                        ...
                                        onClick={() => {
                                            ...
                                            navigate(`/meeting-types/edit/${selectedMeetingForDetails._id}`);
                                        }}
                                    >
                                        <FiCalendar className="me-2" />
                                        Edit Meeting Type
